...
namespace BinaryIO
{
    public class BinaryStream : MemoryStream
    {
        ...
        {
            return BitConverter.ToInt16(Reverse(ReadBytes(2), order), 0);
        }
        ...
        {
            return BitConverter.ToUInt16(Reverse(ReadBytes(2), order), 0);
        }
        ...
        {
            return BitConverter.ToInt32(Reverse(ReadBytes(4), order), 0);
        }
        ...
        {
            return BitConverter.ToUInt32(Reverse(ReadBytes(4), order), 0);
        }
        ...
        {
            return BitConverter.ToInt64(Reverse(ReadBytes(8), order), 0);
        }
        ...
        {
            return BitConverter.ToUInt64(Reverse(ReadBytes(8), order), 0);
        }
        ...
        {
            return BitConverter.ToDouble(Reverse(ReadBytes(8), order), 0);
        }
